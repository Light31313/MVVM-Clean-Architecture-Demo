...
import com.giangnh44.base_lib.extension.view.BaseActivity
import com.giangnh44.base_lib.extension.view.BaseDialog
import com.giangnh44.base_lib.extension.view.BaseFragment
...
internal fun <V : ViewBinding> BaseDialog<V>.getBinding(
    inflater: LayoutInflater,
    container: ViewGroup?
): V {
    return findClass().getBinding(inflater, container)
